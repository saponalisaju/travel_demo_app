...
class ComponentToPrint extends React.Component {
  render() {
    ...
    const fileExtension = application?.file2?.split(".").pop().toLowerCase();

    const fileURL = `${apiUrl}/uploads/visa/${application.file2}`;
...
const PrintButtonView2 = ({ apiUrl, application }) => {
