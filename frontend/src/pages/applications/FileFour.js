...
class ComponentToPrint extends React.Component {
  render() {
    ...
    const fileExtension = application?.file3?.split(".").pop().toLowerCase();

    const fileURL = `${apiUrl}/uploads/visa_form/${application.file3}`;
...
const PrintButtonView3 = ({ apiUrl, application }) => {
